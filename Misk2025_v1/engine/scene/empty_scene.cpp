...
namespace scene {
    void Empty_scene::on_load()
    {
        ...
        transform.scale = glm::vec3(1.0f, 1.0f, 1.0f);  // Scale up monkey
        this->add_scene_3d_object("hand.obj", transform);
    ...
    void Empty_scene::on_unload()
    {
        this->scene_3d_objects.clear();
    }
    void Empty_scene::on_update(float delta_time)
    {
    ...
    void Empty_scene::render_scene(Render_data& data)
    {
    ...
    void Empty_scene::render_ui(Render_data& data)
    {
    ...
    void Empty_scene::setup_lighting(Render_data& render_data, float time, bool enable_lighting) {
